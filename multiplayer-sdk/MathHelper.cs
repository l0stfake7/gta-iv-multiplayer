...
namespace MIVSDK
{
    public static class MathHelper
    {
        ...
        /// </summary>
        static Vector3 WorldUp { get { return new Vector3(0.0f, 0.0f, 1.0f); } }
        static Vector3 WorldDown { get { return new Vector3(0.0f, 0.0f, -1.0f); } }
        static Vector3 WorldNorth { get { return new Vector3(0.0f, 1.0f, 0.0f); } }
        static Vector3 WorldSouth { get { return new Vector3(0.0f, -1.0f, 0.0f); } }
        static Vector3 WorldEast { get { return new Vector3(1.0f, 0.0f, 0.0f); } }
        static Vector3 WorldWest { get { return new Vector3(-1.0f, 0.0f, 0.0f); } }
        static Vector3 RelativeRight { get { return new Vector3(1.0f, 0.0f, 0.0f); } }
        static Vector3 RelativeLeft { get { return new Vector3(-1.0f, 0.0f, 0.0f); } }
        static Vector3 RelativeFront { get { return new Vector3(0.0f, 1.0f, 0.0f); } }
        static Vector3 RelativeBack { get { return new Vector3(0.0f, -1.0f, 0.0f); } }
        static Vector3 RelativeTop { get { return new Vector3(0.0f, 0.0f, 1.0f); } }
        static Vector3 RelativeBottom { get { return new Vector3(0.0f, 0.0f, -1.0f); } }
