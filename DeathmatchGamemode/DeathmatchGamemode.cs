...
namespace DeathmatchGamemode
{
    public class DeathmatchGamemode : Gamemode
    {
            ...
            : base(a)
        {
            ...
            api.createVehicle("INFERNUS", new Vector3(2192.73f, 627.2288f, 5.332971f), new Quaternion(0.0002791698f, -5.590584E-06f, 0.7807003f, 0.6249056f));//4
            api.createVehicle("INFERNUS", new Vector3(2181.76f, 615.1063f, 5.525773f), new Quaternion(0.02005787f, -0.01567191f, 0.9466311f, 0.3213124f));//5
            ...
            api.createVehicle("INFERNUS", new Vector3(2473.699f, 223.2305f, 15.201333f), new Quaternion(-0.01775569f, -0.02556662f, -0.2633584f, 0.9641957f));//7
            api.createVehicle("INFERNUS", new Vector3(2388.855f, 257.8469f, 15.201088f), new Quaternion(0.01293025f, -0.02881934f, 0.6902145f, 0.7229151f));//8
            ...
            api.createVehicle("INFERNUS", new Vector3(2443.699f, 367.3226f, 15.383784f), new Quaternion(-0.008690395f, 0.04274701f, -0.03868492f, 0.9982989f));//10
            ...
            api.createVehicle("INFERNUS", new Vector3(2394.754f, 522.0314f, 15.438295f), new Quaternion(-0.0004053938f, 0.006344253f, 0.6920787f, 0.721794f));//12
            ...
            api.createVehicle("NRG900", new Vector3(2290.812f, 662.457f, 15.437609f), new Quaternion(-0.004348053f, 0.003731936f, 0.5506685f, 0.8347044f));//14
            ...
            api.createVehicle("ANNIHILATOR", new Vector3(2231.183f, 736.4599f, 15.459599f), new Quaternion(-0.003429666f, -0.002095187f, 0.9954517f, 0.09518221f));//16
